...
export class pruebaFlor extends connect(store, SCREEN, MEDIA_CHANGE)(LitElement) {
    constructor() {
        super();
        this.first = true;
        this.alta = true;
    ...
    stateChanged(state, name) {
        ...
        if (name == SCREEN) {
            this.hidden = true;
            const isCurrentScreen = ["pruebaFlor"].includes(state.screen.name);
...
window.customElements.define("prueba-flor", pruebaFlor);
